    ...
    <section class='header' id='header'>
                                ...
                                <div class='cssmenu'>
                                    ...
                                    <ul class='menu-ul'>
                                        <li class='has-sub'>
                                            ...
                                            <a href='home-4.html#'>Home <i class='icon icon-chevron-down'></i></a>
                                            <ul>
                                                <li>
                                        ...
                                        <li class='has-sub'>
                                            ...
                                            <a href='home-4.html#'>Pages <i class='icon icon-chevron-down'></i></a>
                                            <ul>
                                                <li>
                                                ...
                                                <li class='has-sub'>
                                                    <a href='home-4.html#'>Tracking App <i class='icon icon-chevron-down'></i></a>
                                                    <ul>
                                                        <li>

                                                            <a href='tracking-app-1.html'>Tracking App 1</a>
                                                        </li>
                                                        <li>

                                                            <a href='tracking-app-2.html'>Tracking App 2</a>
                                                        </li>
                                                    </ul>
                                                </li>
                                                <li>
                                                ...
                                                <li>
                                                    <a href='service-estimate.html'>Service Estimate</a>
                                                </li>
                                                <li class='has-sub'>
                                                    <a href='home-4.html#'>Gallery <i class='icon icon-chevron-down'></i></a>
                                                    <ul>
                                                        <li>
                                                        ...
                                                        <li>
                                                            ...
                                                            <a href='portfolio-grid-full.html'>Full Grid</a>
                                                        </li>
                                                        <li>
                                        ...
                                        <li class='has-sub'>
                                            ...
                                            <a href='home-4.html#'>About <i class='icon icon-chevron-down'></i></a>
                                            <ul>
                                                <li>
                                        ...
                                        <li class='has-sub'>
                                            ...
                                            <a href='home-4.html#'>Blog <i class='icon icon-chevron-down'></i></a>
                                            <ul>
                                                <li>
                                                    <a href='blog-1.html'>Large Alternate</a>
                                                </li>
                                                <li>
                                                    <a href='blog-3.html'>Medium Alternate</a>
                                                </li>
                                                <li>
                                                    <a href='blog-2.html'>Small</a>
                                                </li>
                                                <li>
                                                    <a href='blog-4.html'>Large Centered</a>
                                                </li>
                                                <li>
                                        ...
                                        <li class='has-sub'>
                                            ...
                                            <a href='home-4.html#'>Shortcodes <i class='icon icon-chevron-down'></i></a>
                                            <ul>
                                                <li>
                                                    <a href='typography.html'>Typography</a>
                                                </li>
                                                <li class='has-sub'>
                                                    <a href='home-4.html#'>Vector Icons <i class='icon icon-chevron-down'></i></a>
                                                    <ul>
                                                        <li>

                                                            <a href='shipping-icons.html'>Shipping Icons</a>
                                                        </li>
                                                        <li>
                                                ...
                                                <li class='has-sub'>
                                                    <a href='home-4.html#'>Sidebar <i class='icon icon-chevron-down'></i></a>
                                                    <ul>
                                                        <li>
        ...
        <div class="header-bg ">
            ...
            <div style="position:relative;display:inline-block;width:100%;height:auto;">
                <img src="img/banner-4.jpg" alt="Header Image" class="img-responsive">
            ...
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 social-wrap hidden-xs">
                <div class="social-box">
                    <div class="social-icons-wrap">
                        <a href="home-4.html#"><i class="icon icon-facebook text-on-primary"></i></a>
                        <a href="home-4.html#"><i class="icon icon-twitter text-on-primary"></i></a>
                        <a href="home-4.html#"><i class="icon icon-google-plus text-on-primary"></i></a>
                    </div>
                </div>
            </div>
    ...
    <section class='features' id='features'>
        <div class="container">
            <div class="row">
                ...
                <p class="subheading">Lorem ipsum dolor sit amet, consectetuer adipiscing elit enean commodo eget dolor aenean massa eget dolor
                    aenean massa</p>
                ...
                <div class="features">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 feature-block inviewport animated delay1" data-effect="fadeInUp">
                        ...
                        <div class="info">
                            ...
                            <p>The arrival and departure times of flights are highly reliable, as airlines tend to be very on
                                top of their schedules.</p>
                        </div>
                    </div>
                    <!-- Feature - End -->
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 feature-block inviewport animated delay2" data-effect="fadeInUp">
                        ...
                        <div class="info">
                            ...
                            <p>Road freight is the most widespread mode of goods transportation these days. Transporting your
                                goods by road freight has many merits.</p>
                        </div>
                    </div>
                    <!-- Feature - End -->
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 feature-block inviewport animated delay1" data-effect="fadeInUp">
                        ...
                        <div class="info">
                            ...
                            <p>We keeps the goods moving, because they can be sent as soon as they are ready rather than waiting
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 feature-block inviewport animated delay2" data-effect="fadeInUp">
                        ...
                        <div class="info">
                            ...
                            <p>We contributes to the price of transporting is the fact that trains have much more space and
                                are able to carry larger volumes of cargo.</p>
                        </div>
                    </div>
                    <!-- Feature - End -->
    ...
    <section class='bg-black' id='worldwide'>
        <div class="container">
            <div class="row">
                ...
                <div class="headul"></div>
                <p class="subheading text-white">Lorem ipsum dolor sit amet, consectetuer adipiscing elit enean commodo eget dolor aenean massa eget dolor
                    aenean massa</p>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-5 col-md-5 col-sm-12 col-xs-12 text-area">
                    ...
                    <p>Asunt in anim uis aute irure dolor in reprehenderit in voluptate cillum dolore eu fugiat nulla pariatur.
                        Excepteur sint occaecat cun proident.</p>
                    <a href="home-4.html#" class="btn btn-primary">Know More</a>
                </div>
                <div class="col-lg-7 col-md-7 col-sm-12 col-xs-12 slider-area">
                    ...
                    <ul id="image-slider" class="owl-carousel">
                        ...
                        <li class="">
                            <img alt="mission-carousel-image" class="lazyOwl img-responsive" data-src="img/mission-1.jpg" src="home-4.html#">
                        </li>
                        <!-- Image Carousel Item - End -->
                        <!-- Image Carousel Item - Start -->
                        <li class="">
                            <img alt="mission-carousel-image" class="lazyOwl img-responsive" data-src="img/mission-2.jpg" src="home-4.html#">
                        </li>
                        <!-- Image Carousel Item - End -->
                        <!-- Image Carousel Item - Start -->
                        <li class="">
                            <img alt="mission-carousel-image" class="lazyOwl img-responsive" data-src="img/mission-3.jpg" src="home-4.html#">
                        </li>
                        <!-- Image Carousel Item - End -->
                    </ul>
                    <!-- Image Carousel - End -->
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 col-xs-12">
                    ...
                    <div class="headul left-align"></div>
                    <p class="subheading left-align">Lorem ipsum dolor sit amet, consectetuer adipiscing elit enean commodo eget dolor aenean massa eget dolor
                        aenean massa ipsum dolor sit amet, consectetuer adipiscing elit enean commodo eget dolor aenean massa
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12 whoweare-info">
                    ...
                    <div class="headul left-align"></div>
                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vestibulum ut mi dictum, bibendum dui sed, dictum
                        odio. Mauris luctus ullamcorper massa eget porttitor. Suspendisse sed vehicula ex. Etiam egestas
                        pellentesque sapien, eget scelerisque urna. In tristique non lorem at ultricies. Integer mauris erat
                        tellus augue, aliquet a semper a, blandit interdum quam.</p>
                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vestibulum ut mi dictum, bibendum dui sed, dictum
                        odio. Mauris luctus ullamcorper massa eget porttitor.</p>
                    <a href="home-4.html#" class="btn btn-primary">Know More</a>
                </div>
            </div>
        </div>
        ...
        <div class="estimate-wrap">
            <div class="row">
                <div class="col-lg-8 col-md-8 col-lg-offset-1 col-md-offset-1 col-sm-offset-1 col-sm-10  col-xs-offset-1 col-xs-10 ">
                    ...
                    <div class="headul left-align"></div>
                    <p class="subheading left-align">Lorem ipsum dolor sit amet, consectetuer adipiscing elit enean commodo eget dolor aenean massa eget dolor
                        aenean massa ipsum dolor sit amet, consectetuer adipisc</p>
                </div>
                ...
                <div class="col-lg-4 col-md-4 col-lg-offset-1 col-md-offset-1 col-sm-offset-1 col-sm-10  col-xs-offset-1 col-xs-10 ">
                    ...
                    <div class='row'>
                        <form action='#' method='post'>
                            ...
                            <div
                                class='col-xs-6'><label>Quantity</label><input type='text' placeholder='' class='transition' id='est_qty'></div>
                    <div
                        class='col-xs-6'><label>Weight</label><input type='text' placeholder='' class='transition' id='est_weight'></div>
                <div
                    class='col-xs-4'><label>Length</label><input type='text' placeholder='' class='transition' id='est_length'></div>
                        ...
                        <ul id="testimonial-carousel" class="owl-carousel">
                            ...
                            <li class="">
                                <h5 class="testi" data-id="testi-1">
                                    Shipping Logistics is one of the top logistics providers in the industry. and first class customer service and live by the
	              ...
	              <div class="tweet_time">1 day ago</div> -->
                            ...
                            <li class="">
                                <h5 class="testi" data-id="testi-2">
                                    Asunt in anim uis aute irure dolor in reprehenderit in voluptate cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat
                                    cun proident, sunt in anim id est laborum. </h5>
                                <div class="testi_by">
                                    <div class="pic">
                ...
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 ">
                    ...
                    <div class='row'>
                        <form action='send_email.php' method='post'>
                            <div class='col-xs-6'><input type='text' placeholder='Name' class='transition' id='c_name'></div>
                            <div class='col-xs-6'><input type='text' placeholder='Email' class='transition' id='c_email'></div>
                            <div class='col-xs-12'><textarea class='transition' placeholder='Message' id='c_message'></textarea></div>
                            <div id='response_email'
                                class='col-xs-12'></div>
                            <div class='col-xs-4'><button type='button' class='btn btn-primary disabled transition' id='c_send'>Send Message</button></div>
                        </form>
                    </div>
                    <!-- Contact Form - End -->
                </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 text-widget inviewport animated delay1" data-effect="fadeInUp">
                    ...
                    <p>This is a unique & creatively designed layout built in HTML+Photoshop with a modern look. All the files
                        are well organized and named as per content. Its very easy to change any part.</p>
                ...
                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 news-widget inviewport animated delay2" data-effect="fadeInUp">
                    ...
                    <div class="news-wrap row">
                        ...
                        <div class="info col-md-9 col-xs-9 col-sm-9 col-lg-9">
                            <h5 class="title"><a href='home-4.html#'>ROAD FREIGHT AND LOGISTICS AWARD OF THE YEAR</a></h5>
                    ...
                    <div class="news-wrap row">
                        <div class="pic col-md-3 col-xs-3 col-sm-3 col-lg-3">
                            <img alt="news-image" class="img-responsive" src="img/news-2.jpg">
                        </div>
                        <div class="info col-md-9 col-xs-9 col-sm-9 col-lg-9">
                            <h5 class="title"><a href='home-4.html#'>AIR FREIGHT AND LOGISTICS AWARD OF THE YEAR</a></h5>
                            <div class="date">21st October 2015</div>
                        </div>
                    </div>
                ...
                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 contact-widget inviewport animated delay3" data-effect="fadeInUp">
                    <h4>Contact</h4>
                    <div class="headul left-align"></div>
                    <p>8400 6th Street North, sector Quater 2,<br>Madison Avenue, Main street Bridge,<br>RINGROAD<br>NY, 13027</p>
                ...
                <div class="container">
                    <div class="">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 social">
                            <a href="home-4.html#" class="inviewport animated delay1" data-effect="fadeInUp"><i class="icon icon-facebook text-on-primary"></i></a>
                            <a href="home-4.html#" class="inviewport animated delay2" data-effect="fadeInUp"><i class="icon icon-twitter text-on-primary"></i></a>
                            <a href="home-4.html#" class="inviewport animated delay3" data-effect="fadeInUp"><i class="icon icon-dribbble text-on-primary"></i></a>
                            <a href="home-4.html#" class="inviewport animated delay4" data-effect="fadeInUp"><i class="icon icon-google-plus text-on-primary"></i></a>
                            <a href="home-4.html#" class="inviewport animated delay5" data-effect="fadeInUp"><i class="icon icon-youtube-play text-on-primary"></i></a>
                        </div>
                    </div>
                </div>
            </div>
